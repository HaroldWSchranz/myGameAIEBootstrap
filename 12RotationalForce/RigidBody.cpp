...
Rigidbody::Rigidbody(ShapeType shapeID, glm::vec2 position, glm::vec2 velocity, float orientation, float angularVelocity, float mass)
{
	m_shapeID = shapeID;
	m_position = position;
	m_velocity = velocity;
...
Rigidbody::Rigidbody(ShapeType shapeID, glm::vec2 position, float inclination, float speed, float orientation, float angularVelocity, float mass)
{
	m_shapeID = shapeID;
	m_position = position;
