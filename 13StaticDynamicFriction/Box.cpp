...
Box::Box(glm::vec2 position, glm::vec2 velocity, float orientation, float angularVelocity, float mass, float width, float height, glm::vec4 colour) :
	Rigidbody::Rigidbody(BOX, position, velocity, orientation, angularVelocity, mass)
{
...
Box::Box(glm::vec2 position, float inclination, float speed, float orientation, float angularVelocity, float mass, float width, float height, glm::vec4 colour) :
	Rigidbody::Rigidbody(BOX, position, inclination, speed, orientation, angularVelocity, mass)
{
	m_extents.x = width / 2.f;
	m_extents.y = height / 2.f;
	//store the local axes 
